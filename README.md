...
Truy cập [https://github.com/cdarlint/winutils](https://github.com/cdarlint/winutils), chọn thư mục hadoop-3.2.2. Tìm file winutils.exe, bấm vào nó và chọn nút Download (hoặc View Raw để tải về). Làm tương tự với file hadoop.dll. Sau đó, cho 2 file đó vào D:\Hadoop\bin để làm HADOOP_HOME
Tiếp đó:
- Copy file hadoop.dll.
- Mở thư mục C:\Windows\System32 và dán file đó vào đây (Windows có thể sẽ hỏi quyền Administrator, chọn Continue).
- Restart lại VS Code để Windows nhận diện file DLL mới.
